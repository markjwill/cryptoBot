...
i = 0
first = True
while first or len(results) > 0:
  first = False
  offset = (i * 200) + 500000
  print("OFFSET: %s"% offset)
  i += 1
  cur.execute("SELECT %s FROM trades WHERE trades.p_oneTwentyMin_changePercent IS NOT NULL AND trades.p_oneTwentyMin_changePercent!=0 AND trades.f_oneTwentyMin_changePercent IS NOT NULL AND trades.f_oneTwentyMin_changePercent!=0 ORDER BY trades.id ASC LIMIT 200 OFFSET %s"% (selectCols, offset))

  results = cur.fetchall()
  
  for row in results:
    if row[5] != 0:
      cur.execute("SELECT coinbasePrice, binancePrice, huobiPrice, bittrexPrice, BCHprice, ETHprice FROM outsidePrices WHERE tradeId = %s "% row[0] )
      outsideRow = cur.fetchone()
      ...
      cur.executemany("INSERT INTO prepedTrades (%s) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"% (insertCols, offset) )
      break
